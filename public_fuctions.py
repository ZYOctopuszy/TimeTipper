...
def resource_path(relative_path: str) -> str:
    ...
    file_path = os.path.dirname(os.path.abspath(__file__)) if hasattr(sys, "_MEIPASS") else abspath(".")
    return join(file_path, relative_path)
...
def set_window_size(window: QWidget, application: QApplication):
    ...
    """
    # 获取屏幕的尺寸
    primary_screen: QScreen = application.primaryScreen()
