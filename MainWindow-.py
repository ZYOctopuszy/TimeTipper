...
class MainWindow(classes.basic_classes.MyQWidget):
    """
    自定义主窗口类
    """
    ...
    def __init__(self, app: QApplication):
        ...
        # 初始化日志管理类
        self.log_manager = classes.LogManager(self)
        # 软件激活状态
        ...
        self.time_config: list[list[classes.basic_classes.Clock]] = (
    ...
    def son_classes_init(self):
        ...
        """
        # region 初始化状态管理器
        self.status_manager = classes.basic_classes.StatusManager(self)
